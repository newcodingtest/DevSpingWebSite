...
<div>
    <form action="/member/customRegister" method="post">
    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
    <table class="joinform">
        <tr>
        <td class="joinsort">ID</td>
        <td class="joininputbox">
            <input type="text" placeholder="Email 입력" name="userid" id="input_id" class="joininput">
        ...
        <td colspan="2" class="joininputbox">
            <input type="password" placeholder="비밀번호를 입력하세요" name="userpw" id="password" class="joininput"> 
        ...
        <td colspan="2" class="joininputbox">
            <input type="text" placeholder="이름을 입력하세요" name="username" class="joininput">
        </td>
        </tr>
    <!--     <tr>
        ...
        <tr>
        <td colspan="3" align="center"><button type="submit" value="가입하기" class="joinsubmit" >가입하기</button></td>
        </tr>
    </table>
		...
		function idCheck() { // 
			...
			$.ajax({
				...
				success : function(data) {
					...
					//var check=document.getElementById("checkId"); //값 식별
					if(data>0){
