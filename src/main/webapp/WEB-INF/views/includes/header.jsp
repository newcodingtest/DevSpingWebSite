    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Seva buddies</a>
            </div>
            <!-- /.navbar-header -->
    ...
    <li class="divider"></li>
		<sec:authorize access="isAuthenticated()"> 
		 <li><a href="/member/myProfile"><i class="fa fa-sign-out fa-fw"></i>
		  ...
		  <li><a href="/message/list"><i class="fa fa-sign-out fa-fw"></i>
		   쪽지함</a></li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/Gboard/list"><i class="fa fa-bar-chart-o fa-fw"></i> 갤러리형 게시판<span class="fa arrow"></span></a>
